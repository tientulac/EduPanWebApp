...
@Component({
  selector: 'app-loai-ho-tro',
  templateUrl: './loai-ho-tro.component.html',
  styleUrls: ['./loai-ho-tro.component.scss']
})
export class LoaiHoTroComponent implements OnInit {
  ...
  GetAll() {
    this.LoaiHoTro.LoaiHoTro_Load_List(this.Token)
      .subscribe(z => {
